...
class MultilayerPerceptron:
    ...
    def __init__(self, training_set, expected_output, learning_rate, hidden_layers, adaptive_eta_params = None, batch = False, momentum = False):
    ...
    def calculate_error_2(self): 
        ...
        for i in range(len(self.training_set)):
            ...
            error += 0.5 * (1 + expected)*np.log((1+expected)/(1+activation_state),10) + 0.5 * (1-expected)*np.log((1-expected)/(1-activation_state),10)
        return error
